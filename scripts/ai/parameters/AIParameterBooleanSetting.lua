...
function AIParameterBooleanSetting.new(data,vehicle,customMt)
	...
	local self = AIParameterSettingList.new(data,vehicle,customMt or AIParameterBooleanSetting_mt)
