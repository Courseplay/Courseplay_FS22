...
function Course:saveToXml(courseXml, courseKey)
    ...
    courseXml:setValue(courseKey .. '#headlandClockwise', self.headlandClockwise)
    courseXml:setValue(courseKey .. '#islandHeadlandClockwise', self.islandHeadlandClockwise)
