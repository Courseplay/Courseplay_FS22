...
function testRowPatternSkip()
    ...
    entries[5].position:assertAlmostEquals(Vector(0, 9))
    entries[6].position:assertAlmostEquals(Vector(20, 9))
    entries[7].position:assertAlmostEquals(Vector(0, 2))
    entries[8].position:assertAlmostEquals(Vector(20, 2))
    ...
    entries[3].position:assertAlmostEquals(Vector(0, 10))
    entries[4].position:assertAlmostEquals(Vector(20, 10))
    entries[5].position:assertAlmostEquals(Vector(0, 2))
    entries[6].position:assertAlmostEquals(Vector(20, 2))
    entries[7].position:assertAlmostEquals(Vector(0, 9))
    entries[8].position:assertAlmostEquals(Vector(20, 9))
    ...
    entries[5].position:assertAlmostEquals(Vector(0, 10))
    entries[6].position:assertAlmostEquals(Vector(20, 10))
    entries[7].position:assertAlmostEquals(Vector(0, 2))
    entries[8].position:assertAlmostEquals(Vector(20, 2))
    ...
    entries[3].position:assertAlmostEquals(Vector(0, 11))
    entries[4].position:assertAlmostEquals(Vector(20, 11))
    entries[5].position:assertAlmostEquals(Vector(0, 3))
    entries[6].position:assertAlmostEquals(Vector(20, 3))
    entries[7].position:assertAlmostEquals(Vector(0, 9))
    entries[8].position:assertAlmostEquals(Vector(20, 9))
end
