...
function CourseGeneratorInterface.generateVineCourse(fieldPolygon,
	...
	CourseGenerator.debug('Generating course, width %.1f m, turn radius %.1f m',
			workWidth, turnRadius)
	CourseGenerator.debug('                   row direction %d, rows to skip %d',
			rowDirection, rowsToSkip)
